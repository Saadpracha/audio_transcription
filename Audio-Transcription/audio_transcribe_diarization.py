...
class AudioTranscriberWithDiarization:
    ...
    def load_models(self) -> None:
        ...
        if self.diarization_pipeline is None:
            ...
            if not token:
                raise RuntimeError("❌ HUGGINGFACE_TOKEN not set in environment or .env file. Visit https://hf.co/settings/tokens to create one and accept conditions at https://hf.co/pyannote/speaker-diarization.")
            try:
                ...
                raise RuntimeError(f"❌ Failed to load diarization model: {e}. Ensure token has access and conditions are accepted at https://hf.co/pyannote/speaker-diarization.")
